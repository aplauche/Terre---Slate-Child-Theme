...
<div class="wp-block-buttons"><!-- wp:button {"width":100,"className":"is-style-primary-button"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-primary-button"><a class="wp-block-button__link wp-element-button">Your Custom Link Here</a></div>
<!-- /wp:button -->

<!-- wp:button {"width":100,"className":"is-style-primary-button"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-primary-button"><a class="wp-block-button__link wp-element-button">Your Custom Link Here</a></div>
<!-- /wp:button -->
